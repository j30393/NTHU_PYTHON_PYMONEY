...
class Records:
    ...
    def add(self, add_things, name):
        ...
        if(is_arguement_valid <= 0):
            print('invalid input the input should be as < YYYY-MM-DD meal breakfast -50 >')
            return 
...
while True:
    ...
    if command == 'add':
        record = input('Add an expense or income record with date (optional), category, description, and amount (separate by spaces):\n')
